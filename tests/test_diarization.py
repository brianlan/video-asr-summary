...
class TestPyannoteAudioProcessor:
    ...
    def test_init(self):
        ...
        processor = PyannoteAudioProcessor(
...
class TestSegmentBasedIntegrator:
    ...
    def test_integrate_no_overlap(self):
        ...
        diarization = DiarizationResult(
            segments=[SpeakerSegment(2.0, 3.0, "SPEAKER_00")],
            num_speakers=1
        )
    ...
    def test_integrate_partial_overlap_below_threshold(self):
        ...
        diarization = DiarizationResult(
            segments=[SpeakerSegment(1.5, 3.0, "SPEAKER_00")],
            num_speakers=1
        )
    ...
    def test_integrate_invalid_segment_timing(self):
        ...
        transcription = TranscriptionResult(
            text="Hello",
            confidence=0.9,
            segments=[{"start": 2.0, "end": 1.0, "text": "Hello"}]  # Invalid: start > end
        )
